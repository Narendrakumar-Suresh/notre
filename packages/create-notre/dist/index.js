...
function createProject(targetDir, config) {
    ...
    // tailwind.config
    writeFile(targetDir, `tailwind.config.${configExt}`, getTailwindConfig(config));
    // app.css
...
function getEntryClient(config) {
...
function getEntryServer(config) {
